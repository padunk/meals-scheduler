...
import { FaRegCalendarAlt, FaArrowAltCircleRight } from "react-icons/fa";
...
class App extends Component {
    ...
    /*doThing = () => {
    //this.props.dispatch(addRecipe({})) // could also do this instead of mapDispatchToProps
    ...
    render() {
        ...
        return (
            <div className="container">
                <div className="nav">
                    <h1 className="header">Meals Scheduler</h1>
                    <button
